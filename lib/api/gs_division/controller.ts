...
export class UserController {
    ...
    public addDivision(req: Request, res: Response) {
            ...
            this.user_service.createUser(user_params, (err: any, user_data: IUsers) => {
                if (err) {
                    mongoError(err, res);
                } else {
                    successResponse('create Division successfull', user_data, res);
                }
            }); 
    }
